...
class WebSimilarityAnalysisResult:
    ...
    # Rangos (start_offset, end_offset) de TODOS los fragmentos web que
    # superaron el umbral, sin truncar por MAX_MATCHES. `matches` se recorta
    # para el detalle; el cálculo del % total (incluido el número principal
    # del reporte) debe usar este conjunto completo.
